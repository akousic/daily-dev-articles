...
- The release also brings several improvements to Blazor forms.
- A new Label component now renders accessible labels with automatic extraction of display names from metadata attributes.
- It supports both nested and non-nested label-input association patterns.
